...
export async function generatePackageManifest(directoryPath: string, basePath: string) {
    ...
    for (const filePath of filePathList) {
        const relativePath: string = normalizePath(path.relative(basePath, filePath));
